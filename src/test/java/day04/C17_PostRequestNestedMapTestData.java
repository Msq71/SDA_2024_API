...
public class C17_PostRequestNestedMapTestData extends PetStoreBaseUrl {
 ...
 */
    ...
    public void postNestedMapTest() {
        ...
        Map<String, Object> bookingdates = RestFullTestData.bookingDatesMapper("2023-03-07", "2024-09-25");

        Map<String, Object> payLoad = RestFullTestData.bookingMapper("John", "Doe", 15, true, bookingdates, "Lunch");
